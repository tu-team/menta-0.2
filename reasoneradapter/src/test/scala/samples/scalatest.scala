...
import menta.reasoneradapter.translator.ProbabilisticalLogicOperators.helper.{AddConjunctionIndividualWrapper, AddConjunctionIndividualHelper}
...
class MapSpec extends Spec with MustMatchers {
  ...
  describe ("Conjunction Helper") {
    it ("should initializie the ConjuctionHowTo correctly") {
